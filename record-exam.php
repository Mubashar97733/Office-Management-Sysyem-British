...
<head>
    ...
    <title>Exam - British Institute</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card recent-sales overflow-auto">
                                    <div class="card-body">
                                        <h5 class="card-title">Exam Booked <span>| All</span></h5>
                                        <?php
                                        $data = display_order_2("bisa_exam_booked", "eb_date", "eb_id");
                                        if ($data) {
                                        ?>
                                                        ...
                                                        ?>
                                                            <tr class="<?php echo $user['eb_id']; ?>">
                                                                ...
                                                                <td><?php if ($user['eb_fee_meth'] == 'Self-paid') { ?><i class="bi bi-three-dots"></i><?php } else {
                                                                    if($user['eb_bi_fee']==NULL || $user['eb_bi_fee']==0){ ?><i class="bi bi-three-dots"></i><?php }else{ echo $user['eb_bi_fee']; }
                                                                                                                                                } ?></td>
                                                                <td><?php if ($user['eb_fee_meth'] == 'Self-paid') { ?><i class="bi bi-three-dots"></i><?php } else {
                                                                    if($user['eb_bi_meth']==NULL){ ?><i class="bi bi-three-dots"></i><?php }else{ echo $user['eb_bi_meth']; }
                                                                                                                                                } ?></td>
                                                                <td><?php if ($user['eb_fee_meth'] == 'Self-paid') { ?><i class="bi bi-three-dots"></i><?php } else {
                                                                ...
                                                                <td><?php if ($user['eb_fee_meth'] == 'Self-paid') { ?><i class="bi bi-three-dots"></i><?php } else {
                                                                    if($user['eb_bi_fee']==NULL || $user['eb_bi_fee']==0){ ?><i class="bi bi-three-dots"></i><?php }else{ echo $user['eb_profit']; }
                                                                                                                                                } ?></td>
                                                                <td>

                                                                    ...
                                                                    <tr class="<?php echo $user['u_id']; ?>">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                                                ...
                                                                                <li>
                                                                                    <a class="dropdown-item d-flex align-items-center" href="create-user.php?edit_user=<?php echo $user['u_id']; ?>">
                                                                                ...
                                                                                <li>
                                                                                    <button class="dropdown-item d-flex align-items-center" onclick="delete_ur(<?php echo $user['u_id']; ?>);">

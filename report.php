...
<body class="toggle-sidebar">
    ...
    if (isset($_SESSION['name'])) {
        ...
        if (isset($_REQUEST['date']) && isset($_REQUEST['office']) && isset($_REQUEST['srname'])) {
            $date = $_REQUEST['date'];
            $on = $_REQUEST['office'];
            $osn = $_REQUEST['srname'];
    ?>
                ...
                <section class="section dashboard">
                    <div class="row">
                        <div class="col-lg-12">
                            <div>
                                ...
                                $pff_con = array(
                                    "a_on" => $on,
                                    "a_osn" => $osn,
                                    "a_tfee" => "a_dis + a_fee1 + a_fee2 + a_fee3"
                                );
                                ...
                                $fee = sum_where("bisa_admission", "a_tfee", $ad_con);
                                $dis = sum_where("bisa_admission", "a_dis", $ad_con);

                                $pff = display_count_where("bisa_admission", $pff_con);
                                $admission = display_where("bisa_admission", $ad_con);
                                ?>
                            </div>
                            <div class="row">
                        ...
                        <div class='col-md-12 text-center'><br />
                            <hr />
                            <table class='table table-light table-striped table-bordered table-primary' id='excel-table' style="border:2px solid black; margin-top:50px;">
                                <tr>
                                    <th colspan="5" style="color: red; font-size: 20px"> Short Detail</th>
                                </tr>
                                <tr>
                                    <th>Total Visiters</th>
                                    <td><?php echo $ad + $inq; ?></td>
                                    <td></td>
                                    <th>Total Fee</th>
                                    <td><?php echo $fee; ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <th>Pending Dues</th>
                                    <td><?php echo $fee - $dis - $total_fee; ?></td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td></td>
                                    <td></td>
                                    <th>Students Paid Full Fee</th>
                                    <td><?php echo $pff; ?></td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td></td>
                                    <td></td>
                                    <th>Students Pendng Dues</th>
                                    <td><?php echo $ad - $pff; ?></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr>
                                    <th colspan="4" style="color: red; font-size: 20px;">Fee Details</th>
                                </tr>
                                <?php Report_fee($date, $on, $osn); ?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <th colspan="4" style="color: red; font-size: 20px;">Expence Details</th>
                                </tr>
                                <?php Report_ex($date, $on, $osn); ?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                </tr>
        ...
        if (isset($_REQUEST['start']) && isset($_REQUEST['end']) && isset($_REQUEST['office']) && isset($_REQUEST['srname'])) {
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div>
                                ...
                                $ad = display_count_where_bet("bisa_admission", $ad_con, "a_date", $start, $end);
                                $inq = display_count_where_bet("bisa_inquiry", $inq_con, "inq_date", $start, $end);
                                $total_fee = sum_where_bet("bisa_fee", "f_rs", $f_con, "f_date", $start, $end);
                                $total_in = sum_where_bet("bisa_in_out", "io_rs", $in_con, "io_date", $start, $end);
                                $total_ex = sum_where_bet("bisa_in_out", "io_rs", $ex_con, "io_date", $start, $end);
                                ?>
                            </div>
                            <div class="row">
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        if ($d) {
                                                                                                            foreach ($d as $u) {
                                                                                                                ...
                                                                                                                $inq = display_count_where_bet("bisa_inquiry", $con, "inq_date", $start, $end);
                                                                                                        ?>
                                                                                                                <div class="col-6 col-md-2">
                                                                                                                    <div class="card <?php if ($inq > 0) {
                                                                                                                                            echo "text-bg-secondary";
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content pt-2" id="myTabContent">
                                                <div class="tab-pane fade show active" id="inquiry" role="tabpanel" aria-labelledby="inquiry-tab">
                                                    ...
                                                    $data = display_where_bet("bisa_inquiry", $condition, "inq_date", $start, $end);
                                                    if ($data) {
                                                    ?>
                                                        <table class="table table-borderless table-striped table-hover datatable">
                                                            <thead>
                                                ...
                                                <div class="tab-pane fade" id="admission" role="tabpanel" aria-labelledby="admission-tab">
                                                    ...
                                                    $data = display_where_bet("bisa_admission", $condition, "a_date", $start, $end);
                                                    if ($data) {
                                                    ?>
                                                        <table class="table table-borderless table-striped table-hover datatable">
                                                            <thead>
                        ...
                        <?php include "report/monthly-report.php"; ?>
                    </div>
                </section>
            </main>
        <?php

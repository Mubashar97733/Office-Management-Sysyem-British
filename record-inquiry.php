                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card recent-sales overflow-auto">
                                    <div class="card-body">
                                        <h5 class="card-title">Inquiries <span>| All</span></h5>
                                        <?php
                                        if($_SESSION['status']== "Admin"){
                                            $data = display_order_2("bisa_inquiry", "inq_date", "inq_id");
                                        }else{
                                            $condition = array(
                                                "inq_on" => $_SESSION['office'],
                                                "inq_osn" => $_SESSION['srname']
                                            );
                                            $data = display_where_order("bisa_inquiry", $condition, "inq_date", "inq_id");
                                        }
                                        if ($data) {
                                        ?>
